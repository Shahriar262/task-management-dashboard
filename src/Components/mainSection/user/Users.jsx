  ...
  return (
   <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 w-full lg:w-[380px] 2xl:w-110 shrink-0 mx-auto lg:mx-0">
      ...
      <div className="space-y-4">
        {users.map((user) => (
          <div key={user.id} className="flex justify-between items-center p-2 hover:bg-gray-50 rounded-lg transition-colors gap-2">
            <section className="flex items-center gap-2 min-w-0">
              <img src="/src/assets/avatar.jpg" className="w-10 h-10 rounded-full shrink-0" alt="" />
